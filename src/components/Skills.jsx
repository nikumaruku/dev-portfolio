...
const Skills = () => {
  return (
    <div
      name="skills"
      className="w-full md:h-screen bg-black py-8 border-2 border-white"
    >
      {/* Container */}
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center items-center w-full h-full ">
        <div className="border-2 border-black flex flex-col justify-center items-center space-y-5">
          ...
          <p className="text-black text-sm text-white">My Tech Stack</p>
        </div>

        <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-4 text-center py-8 flex">
